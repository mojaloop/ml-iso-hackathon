...
export const MOJA_QUOTE_RESPONSE_JPATHS : MojaQuoteResponse = {
  ...
  initiatingPartyBic: 'Document.CdtrPmtActvtnReq.GrpHdr.InitgPty.Id.AnyBIC',
  ...
  transferCondition: 'Document.CdtrPmtActvtnReq.PmtInf.Cndtn',
  transactionId: 'Document.CdtrPmtActvtnReq.PmtInf.CdtTrfTxInf.PmtId.EndToEndId',
  sendAmount: 'Document.CdtrPmtActvtnReq.PmtInf.CdtTrfTxInf.Amt.InstdAmt',
  sendCurrency: 'Document.CdtrPmtActvtnReq.PmtInf.CdtTrfTxInf.Amt.$Attribute.Ccy',
